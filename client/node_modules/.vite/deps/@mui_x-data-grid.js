...
} from "./chunk-HSKTYAA5.js";
import "./chunk-UI6YORZN.js";
import {
  require_react_dom
} from "./chunk-ZRJG7NCB.js";
import {
  useTheme
} from "./chunk-XM3FCPUC.js";
import {
  createSvgIcon,
  init_utils as init_utils2,
  useId_default
} from "./chunk-6KWG32GP.js";
import {
  styled_default as styled_default2,
  useThemeProps
} from "./chunk-JEU2ZIWX.js";
import {
  alpha,
  darken,
  decomposeColor,
...
var propValidatorsDataGrid = [(props) => props.autoPageSize && props.autoHeight && ["MUI X: `<DataGrid autoPageSize={true} autoHeight={true} />` are not valid props.", "You cannot use both the `autoPageSize` and `autoHeight` props at the same time because `autoHeight` scales the height of the Data Grid according to the `pageSize`.", "", "Please remove one of these two props."].join("\n") || void 0, (props) => props.signature === GridSignature.DataGrid && props.paginationMode === "client" && isNumber(props.rowCount) && 'MUI X: Usage of the `rowCount` prop with client side pagination (`paginationMode="client"`) has no effect. `rowCount` is only meant to be used with `paginationMode="server"`.' || void 0];
